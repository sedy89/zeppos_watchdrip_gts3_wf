...
WatchFace({
    initView() {
        ...
        normal_date_img_date_year = hmUI.createWidget(hmUI.widget.IMG_DATE, NORMAL_DATE_YEAR_IMG);
        ...
        normal_img_drip = hmUI.createWidget(hmUI.widget.IMG, DRIP_IMG);
        normal_img_drip.addEventListener(hmUI.event.CLICK_DOWN, function (info) {
            hmApp.startApp({ appid: 28962, url: 'page/index'})
          });
        ...
        normal_heart_jumpable_img_click = hmUI.createWidget(hmUI.widget.IMG_CLICK, HEART_IMG);
        ...
        normal_heart_rate_text_separator_img =  hmUI.createWidget(hmUI.widget.IMG, NORMAL_HEART_RATE_SEPARATOR_TEXT_IMG)

        normal_step_current_text_img = hmUI.createWidget(hmUI.widget.TEXT_IMG, NORMAL_STEP_TEXT_IMG);
        normal_step_current_separator_img =  hmUI.createWidget(hmUI.widget.IMG, NORMAL_STEP_SEPARATOR_TEXT_IMG)
        ...
        birdStaleCage = hmUI.createWidget(hmUI.widget.IMG, BIRD_STALE_IMG);
    ...
    updateValuesWidget(watchdripData) {
        ...
        bgTrendImageWidget_AOD.setProperty(hmUI.prop.SRC, bgObj.getArrowResourceAOD());
        ...
        iob.setProperty(hmUI.prop.MORE, { text: iobValue.replace("IOB: ", "").replace("u", "")});
    ...
    updateTimesWidget(watchdripData) {
        ...
        birdStaleCage.setProperty(hmUI.prop.VISIBLE, isStale);
    ...
    build() {
        try{
            ...
            watchdrip.createGraph(100,235,195,140, lineStyles);
            watchdrip.start();
        }
        catch (e) {
