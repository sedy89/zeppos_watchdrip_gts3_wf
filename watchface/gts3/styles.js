...
export const NORMAL_DIGITAL_CLOCK_IMG_TIME = {
    hour_startX: px(129),
    hour_startY: px(157 + 28),
    hour_array: clockNum_Arr,
    hour_zero: 1,
    hour_space: 3,
    hour_align: hmUI.align.CENTER_H,

    minute_startX: px(232),
    minute_startY: px(157 + 28),
    ...
    second_startX: px(314),
    second_startY: px(157 + 28),
