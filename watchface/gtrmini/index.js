...
WatchFace({
    initView() {
        ...
        function scale_call() {
            ...
            if (screenType != hmSetting.screen_type.AOD) {
                ...
                let center_x_normal_pai = 195 + x_offset;
                let center_y_normal_pai = 216 + y_offset;
            ...
            if (screenType != hmSetting.screen_type.AOD) {
                ...
                let center_x_normal_battery = 192 + x_offset;
                let center_y_normal_battery = 220 + y_offset;
            ...
            if (screenType != hmSetting.screen_type.AOD) {
                ...
                let center_x_normal_step = 62 + x_offset;
                let center_y_normal_step = 224 + y_offset;
            ...
            if (screenType != hmSetting.screen_type.AOD) {
                ...
                let center_x_normal_heart_rate = 114 + x_offset;
                let center_y_normal_heart_rate = 336 + y_offset;
    ...
    build() {
        try{
            ...
            watchdrip.createGraph(172 + x_offset, 280 + y_offset,140,70, lineStyles);
            watchdrip.start();
        }
        catch (e) {
